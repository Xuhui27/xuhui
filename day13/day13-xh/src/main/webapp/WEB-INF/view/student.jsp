        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="mId" id = "txt_search_mId">
						<option value="0">---请选择---</option>
						<c:forEach items="${majoList }" var="m">
	    		    ...
	    		    success:function(res){
	    		    	if(res.success){
	    	    			...
	    	    			res.list.forEach(function(studentVo) {
								xdata.push(studentVo.mName);
								ydata.push( {value: studentVo.num, name: studentVo.mName});
							})
							var option = {
	    	    			    title: {
	    	    			        text: '南丁格尔玫瑰图',
