					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>学生性别：</td>
								<td><input type="radio" id="sex1" name="sex" value = "男"/>男
								 <input type="radio" id="sex2" name="sex" value = "女"/>女</td>
							</tr>
								<td>头像：</td>
...
<div class="modal fade" id="modal_user_echarts" role="dialog"
		aria-labelledby="modal_user_echarts" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">×</button>
					<h4 class="modal-title" id="modal_user_del_head">报表统计</h4>
				</div>
				<div class="modal-body">
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
			...
			.click(
					function() {
						var MyEcharts = echarts.init(document
								.getElementById("main"));
